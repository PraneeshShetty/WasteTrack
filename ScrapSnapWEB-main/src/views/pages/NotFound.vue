...
<template>
    <div class="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
        <div class="flex flex-column align-items-center justify-content-center">
            <img src="/icons/icon-512x512.png" alt="WasteTrack logo" class="mb-5 w-6rem flex-shrink-0" />
                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style="border-radius: 53px">
                    ...
                    <router-link to="/" class="w-full flex align-items-center py-5 border-300 border-bottom-1">
                        ...
                        <span class="ml-4 flex flex-column">
                            ...
                            <span class="text-600 lg:text-xl">Find answers to your questions</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
                        ...
                        <span class="ml-4 flex flex-column">
                            ...
                            <span class="text-600 lg:text-xl">Manage your permissions</span>
                        </span>
                    </router-link>
                </div>
            </div>
