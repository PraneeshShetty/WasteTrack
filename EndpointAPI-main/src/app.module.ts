...
import { InappropriateDisposalsModule } from './modules/inappropriate-disposals/inappropriate-disposals.module';

@Module({
  imports: [UserModule, AuthModule, ScheduleModule, EnumModule, CollectionPointsModule, StatsModule,
            SubscriptionsModule, ImageSnapsModule, RoleModule, PermissionModule, InappropriateDisposalsModule],
